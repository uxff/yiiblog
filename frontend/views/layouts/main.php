    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                ...
                <!-- start logo -->
                <a class="branding" href="<?=\yii\helpers\Url::home()?>" title="<?= \common\helpers\SiteHelper::getTitle() ?>"><img src="<?=\yii\helpers\Url::to('@web/image/logo.png')?>" alt="<?= \common\helpers\SiteHelper::getTitle() ?>" style="width:200px;height:60px;"></a>
                <!-- end logo -->
